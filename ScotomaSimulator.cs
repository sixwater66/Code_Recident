...
public class ScotomaSimulator : MonoBehaviour {
	...
	void Awake () {
        ...
        _m = new Material(Shader.Find("Scotoma/Scotoma"));
	...
	void Update(){
        Debug.Log("updatee " + gameObject.name);
	...
	void OnPreRender(){
        Debug.Log("onprerender " + gameObject.name);
        // Update eye matrices
        Matrix4x4 local;
	...
	void OnRenderImage(RenderTexture src, RenderTexture dest){
        Debug.Log("OnRenderImage called on " + gameObject.name);
